  ...
  <div class="row g-0">
    ...
    <div class="p-3 col fixed text-white bg-dark">
      ...
      <ul class="nav flex-column">
        ...
        <li>
          <a href="{{ route('home.index') }}" class="mt-2 btn bg-primary text-white">Volver a la página de inicio</a>
        </li>
      </ul>
    </div>
    <!-- sidebar -->
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container">
      <small>
        ...
        Rubén García</a>
        {{-- debes estar registrado con el usuario administrador para poder ver este panel: http://localhost:8000/admin  --}}
      </small>
    </div>
  </div>
  <!-- footer -->
